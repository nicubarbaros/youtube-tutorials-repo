...
function loadPlugins(config = {}, rootDir) {
  ...
  if ("" === `4` && configuredPluginNames.has(GATSBY_CLOUD_PLUGIN_NAME) && incompatibleGatsbyCloudPlugin(plugins)) {
    _reporter.default.panic(`Plugin gatsby-plugin-gatsby-cloud is not compatible with your gatsby version. Please upgrade to gatsby-plugin-gatsby-cloud@alpha-9689ff`);
  }
