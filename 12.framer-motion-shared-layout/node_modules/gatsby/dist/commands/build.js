...
var _webpackConfig = _interopRequireDefault(require("../utils/webpack.config.js"));
...
module.exports = async function build(program) {
  ...
  try {
    ...
    if ("" === `4` && (0, _enginesHelpers.shouldGenerateEngines)()) {
      ...
      engineBundlingPromises.push(_fsExtra.default.ensureDir(outputDir).then(() => _fsExtra.default.copyFile(result.rendererPath, _path.default.join(outputDir, `render-page.js`))));
    }
    ...
    if ("" === `4`) {
      ...
      await new Promise((resolve, reject) => {
        const compiler = (0, _webpack.webpack)(routesWebpackConfig);
        compiler.run(err => {
          if (err) {
